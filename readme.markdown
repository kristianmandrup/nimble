...
- [Nimble ![Build Status](https://travis-ci.org/nim-lang/nimble)](#nimble-img-src%22httpstravis-ciorgnim-langnimble%22-alt%22build-status%22)
  - [Contents](#contents)
  - [Requirements](#requirements)
  - [Installation](#installation)
    - [Using koch](#using-koch)
    - [Using Nimble](#using-nimble)
  ...
  - [Creating Packages](#creating-packages)
    ...
    - [Compile with `nim` after changing the nimble directory](#compile-with-nim-after-changing-the-nimble-directory)
    - [Versions](#versions)
      - [Releasing a new version](#releasing-a-new-version)
        - [Git Version Tagging](#git-version-tagging)
...
Tags your git repo and pushes tag to remote repo (git only)
